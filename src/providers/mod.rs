...
pub fn create_routed_provider_with_options(
    ...
    // Always keep a default provider at index 0 for non-hint model routing.
    ...
    // and max_tokens overrides do not bleed across other routes.
...
mod tests {
    ...
    #[test]
    fn factory_custom_supports_explicit_responses_mode_option() {
        let options = ProviderRuntimeOptions {
            custom_provider_api_mode: Some(CompatibleApiMode::OpenAiResponses),
            ..ProviderRuntimeOptions::default()
        };
