...
Για την πρώτη σας εγκατάσταση και μια γρήγορη γνωριμία με το σύστημα.
...
| :--- | :--- |
| Έχω κλειδί API και θέλω την πιο γρήγορη ρύθμιση | `zeroclaw onboard --api-key sk-... --provider openrouter` |
